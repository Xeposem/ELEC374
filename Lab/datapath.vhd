...
clk: in std_logic;
clr: in std_logic;
encoder_In: in std_logic_vector(15 downto 0);--For the upper 16 bit of encoder to the bus 
reg_enable: in std_logic_vector(15 downto 0);-- for the upper 16 bit of the register since the lower 16 are generated by select and encode
...
signal encoderin: std_logic_vector(15 downto 0);
